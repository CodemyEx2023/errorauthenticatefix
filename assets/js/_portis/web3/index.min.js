  ...
  return (function (e) {
        ...
        (t.encode = function t(r) {
          ...
          (t.decode = function (t, r) {
            ...
            var n = (function t(r) {
              ...
              return { data: f, remainder: r.slice(d) };
            })(c(t));
            if (r) return n;
          ...
          s.map((t) =>
            (function (e, t, r) {
              return new Promise((n, i) => {
                e.sendAsync(
                  { id: 1, jsonrpc: "2.0", method: t, params: r },
                  (e, t) => {
                    if (e) return i(e);
                    n(t.result);
                  }
      ...
      (function (e) {
        ...
        (t.privateKeyVerify = function (e) {
          ...
          (t.sign = function (t, r, i) {
            ...
            return { signature: e.from(a.signature), recovery: a.recid };
          }),
      ...
      function s(e, t) {
        return function () {
          ...
          n.length < e && n.push("latest"),
            r.sendAsync({ method: t, params: n }, i);
        };
      }
      (e.exports = o),
    ...
    function (e, t, r) {
      ...
      e.exports = function ({ blockTracker: e, provider: t }) {
        ...
        async function A(t) {
          ...
          await t.initialize({ currentBlock: o }),
            r++,
            (i[r] = t),
            (t.id = r),
            (t.idHex = f(r));
          return k({ prevFilterCount: n, newFilterCount: l(i).length }), r;
        }
                  ...
                  return function () {
                    ...
                    return new s.Promise(function (t, i) {
                      ...
                      a.addEventListener(n, function r(c) {
                        ...
                        u.postMessage(
                          { penpal: "call", id: s, methodName: e, args: r },
                          d
                        );
                    });
                  };
          ...
          var h = new u(function (t) {
            ...
            y = new s.Promise(function (t, r) {
              ...
              b.addEventListener(n, s),
                ...
                g.postMessage(
                  { penpal: "handshake", methodNames: Object.keys(a) },
                  i
                );
            });
    ...
    function (e, t, r) {
      ...
      function h(e) {
        ...
        const t = { sendAsync: this._handleAsync.bind(this) },
          ...
          function f(n, i) {
            (a = n),
              ...
              c(
                ...
                function () {
                  var n = { id: e.id, jsonrpc: e.jsonrpc, result: o };
                  null != a
                    ? ((n.error = {
    ...
    function (e, t, r) {
      ...
      (t.privateKeyVerify = function (e) {
        ...
        (t.sign = function (e, t, r, i) {
          ...
          var d = c.sign(e, t, { canonical: !0, k: r, pers: i });
          return {
            signature: n.concat([
        ...
        (t.verify = function (e, t, r) {
          ...
          return c.verify(e, n, { x: d.pub.x, y: d.pub.y });
        }),
    ...
    */ var n = Object.getOwnPropertySymbols,
    ...
    function (e, t, r) {
      ...
      e.exports = class extends i {
        constructor(e = {}) {
          ...
          super(Object.assign({ blockResetDuration: t }, e)),
        ...
        (t.default = function (e) {
          ...
          return t
            ...
            : ((r = e),
              ...
              function () {
                var e = a[++s];
                return s < c ? { value: r[e], key: e } : null;
              });
          var r, a, s, c;
        });
      var n = a(r(29)),
          ...
          function n(e) {
            return (
              ...
              r.call(this, function (t) {
                ...
                return f(Object.assign({ blockTracker: r }, e));
              })
            );
          }
          return n;
            ...
            return (
              ...
              r.call(this, function (e) {
                var t = e.blockTracker,
                  r = e.provider;
                e.engine;
                return f({ blockTracker: t, provider: r });
              })
            );
          }
          return n;
        ...
        (l.prototype.parityPostTransaction = function (e, t) {
          ...
          r._parityRequestCount++,
            r.emitPayload(
              ...
              function (e, t) {
                if (e) r._parityRequests[i] = { error: e };
                else {
                  var n = t.result;
        ...
        (l.prototype.parityPostSign = function (e, t, r) {
          ...
          n._parityRequestCount++,
            n.emitPayload(
              ...
              function (e, t) {
                if (e) n._parityRequests[o] = { error: e };
                else {
                  var r = t.result;
    ...
    function (e, t) {
      ...
      e.exports = (e) => ({
        ...
        signatureExport(t, n) {
          b("signature", t, 64);
          const i = { output: (n = y(n, 72)), outputlen: 72 };
        ...
        ecdsaSign(t, n, i = {}, o) {
          ...
          const a = { signature: (o = y(o, 64)), recid: null };
    ...
    function (e, t, r) {
      ...
      e.exports = {
        ...
        ecdsaSign(e, t, r, a, s) {
          ...
          let f;
          try {
            f = n.sign(t, r, { canonical: !0, k: s, pers: a });
          } catch (e) {
            return 1;
          }
          return (
        ...
        ecdsaVerify(e, t, r) {
          const s = { r: e.subarray(0, 32), s: e.subarray(32, 64) },
            c = new o(s.r),
            f = new o(s.s);
        ...
        ecdsaRecover(e, t, r, a) {
          const c = { r: t.slice(0, 32), s: t.slice(32, 64) },
            f = new o(c.r),
            u = new o(c.s);
      ...
      (function (e) {
        ...
        (t.privateKeyExport = function (t, i, o) {
          ...
          (t.signatureImportLax = function (t) {
            ...
            if (f > 32) return null;
            var h = t.slice(u, u + f);
            return h.copy(n, 32 - h.length), { r: r, s: n };
          });
      }.call(this, r(1).Buffer));
    },
    function (e, t, r) {
                  ...
                  l = (function ({ subId: r }) {
                    const n = {
                      ...
                      update: async ({ oldBlock: e, newBlock: n }) => {
                        const i = n,
                          o = c(e);
                        (await f({ provider: t, fromBlock: o, toBlock: i }))
                          .map(u)
                          .forEach((e) => {
                            b(r, e);
                          });
    ...
    function (e, t, r) {
      ...
      var i = {
          ...
          ubiq: { nodeUrl: "https://rpc1.ubiqscan.io", chainId: "8" },
          thundercoreTestnet: {
            nodeUrl: "https://testnet-rpc.thundercore.com:8544",
            chainId: "18",
          },
          orchid: { nodeUrl: "https://public-node.rsk.co", chainId: "30" },
          orchidTestnet: {
          ...
          sokol: { nodeUrl: "https://sokol.poa.network", chainId: "77" },
          core: { nodeUrl: "https://core.poa.network", chainId: "99" },
          xdai: {
          ...
          fuse: { nodeUrl: "https://rpc.fusenet.io", chainId: "122" },
          lightstreams: {
            nodeUrl: "https://node.mainnet.lightstreams.io",
            chainId: "163",
          },
          matic: { nodeUrl: "https://polygon-rpc.com", chainId: "137" },
          maticMumbai: {
                  ...
                  switch (a.label) {
                    ...
                    case 2:
                      return (
                        ...
                        [2, { communication: o, widgetFrame: n }]
                      );
                  }
                });
              });
            ...
            switch (a.label) {
              case 0:
                return Boolean(t.gas)
                  ? [
                      2,
                      { safeGas: t.gas, simpleSend: !1, gasLimitSpecified: !0 },
                    ]
            ...
            (e.prototype.sendAsync = function (e) {
              ...
              return new Promise(function (n, i) {
                t.provider.sendAsync(
                  { id: 42, jsonrpc: "2.0", method: e, params: r },
                  function (e, t) {
                    e ? i(e) : n(t.result);
                  }
                );
              ...
              return (
                (this.engine.send = function (t, r) {
                  if ("string" == typeof t)
                    return new Promise(function (n, i) {
                      e.engine.sendAsync(
                        { jsonrpc: "2.0", id: 42, method: t, params: r || [] },
                        function (e, t) {
                          e ? i(e) : n(t.result);
                        }
                      );
